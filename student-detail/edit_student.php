...
if(isset($_POST['submit']))
{
  ...
  $class=$_POST['class'];
  $sql="update students set studentName=:studentname,studentno=:regno,gender=:sex,age=:age,class=:class,cu_year=:cu_year where id='$sid'";
  $query = $dbh->prepare($sql);
  $query->bindParam(':studentname',$studentname,PDO::PARAM_STR);
  $query->bindParam(':regno',$regno,PDO::PARAM_STR);
  $query->bindParam(':sex',$sex,PDO::PARAM_STR);
  $query->bindParam(':age',$age,PDO::PARAM_STR);
  $query->bindParam(':cu_year',$cu_year,PDO::PARAM_STR);
...
if(isset($_POST['pass']))
{
  ...
  $sql="update students set country=:country,district=:district,state=:state,pincode=:pincode where id='$sid'";
  $query = $dbh->prepare($sql);
                ...
                <div class="active tab-pane" id="companydetail">
                  ...
                  <div class="row">
                    ...
                    <div class="col-md-4">
                      <div class="form-group">
                        <label>year</label>
                        <input class="form-control" name="cu_year" value="<?php  echo $row['cu_year'];?>" required>
                      </div>        
                    </div>
                    <!-- /.col --> 
                  </div>
          ...
          <div class="tab-pane" id="settings">
            <form role="form" id=""  method="post" enctype="multipart/form-data" >
              ...
              <div class="row">
                ...
                <div class="form-group col-md-6">
                  <label for="inputName2" class="col-sm-2 col-md-6 col-form-label">pincode</label>
                  <div class="col-sm-10">
